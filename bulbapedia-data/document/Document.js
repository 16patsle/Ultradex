...
const sectionMap = require("wtf_wikipedia/src/document/_sectionMap");
const toMarkdown = require("wtf_wikipedia/src/output/markdown");
const toHtml = require("wtf_wikipedia/src/output/html");
const toJSON = require("wtf_wikipedia/src/output/json");
const toLatex = require("wtf_wikipedia/src/output/latex");
const setDefaults = require("wtf_wikipedia/src/lib/setDefaults");
...
const methods = {
  ...
  images: function (clue) {
    const arr = sectionMap(this, "images", null);
  ...
  plaintext: function (options) {
    ...
    const arr = this.sections().map((sec) => sec.plaintext(options));
    return arr.join("\n\n");
  },
